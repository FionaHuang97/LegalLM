...
class DataPreprocessor:
    ...
    def process_single_txt_file(self, in_fpath, out_fpath=None):
        ...
        doc = {'bva_id': bva_id}
        #with open(in_fpath, 'r', encoding='iso-8859-15') as f:
...
#     def train_spm(self, model="bpe", model_prefix = "bpe", citation_place_holder="@@@@@", voc_size=35000):
#         txt_path = os.path.join(self.encoding_dir, self.merged_text_filename)
#         args = ["--model_type=", model, " ",
#                "--input=", txt_path, " ",
#                "--user_defined_symbols=", citation_place_holder, " ",
#                "--model_prefix=", model_prefix, " ",
#                "--vocab_size=", str(voc_size), " ",
#                "--max_sentence_length=", str(self.max_seq_len), " "]
#         arg_line = "".join(args)
#         spm.SentencePieceTrainer.Train(arg_line)
